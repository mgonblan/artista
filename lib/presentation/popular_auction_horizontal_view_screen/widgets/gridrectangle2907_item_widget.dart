...
class Gridrectangle2907ItemWidget extends StatelessWidget {
  Gridrectangle2907ItemWidget(this.gridrectangle2907ItemModelObj);

  Gridrectangle2907ItemModel gridrectangle2907ItemModelObj;

  var controller = Get.find<PopularAuctionHorizontalViewController>();
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Obx(
                    () => Text(
                      gridrectangle2907ItemModelObj.abstractfacewomOneTxt.value,
                ...
                Padding(
                  ...
                  child: Obx(
                    () => Text(
                      gridrectangle2907ItemModelObj.byselenaTxt.value,
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.left,
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Obx(
                            () => Text(
                              gridrectangle2907ItemModelObj.priceTxt.value,
                              overflow: TextOverflow.ellipsis,
                              textAlign: TextAlign.left,
